...
/**
 * Renders a single photo card element
 * @param {Photo} photo 
 * @returns {Promise<HTMLElement|null>}
 */
export async function renderPhotoCard(photo) {
    let likesCount = photo.likes || 0;
    let commentsCount = photo.comments_count || 0;
 ...
 * @returns 
 */
export default function ProfileContent(viewedUser, photos) {
    const contentSection = document.createElement('div');
    contentSection.id = 'photos-grid';
